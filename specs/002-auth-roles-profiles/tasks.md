...
- [X] T077 Run `pnpm build` to verify the project compiles without TypeScript errors. Fix any type errors. Ensure all imports resolve correctly and no circular dependencies exist between domain modules.
