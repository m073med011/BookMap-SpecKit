...
type LibrarySettingsPlaceholderPageProps = {
  params: Promise<{ id: string; locale: string }>;
};

export default async function LibrarySettingsPlaceholderPage({
  params,
}: LibrarySettingsPlaceholderPageProps) {
  ...
  return (
    <Card>
      ...
      <CardContent className="text-muted-foreground text-sm">
        Library settings management for <strong>{library.name}</strong> is staged next.
      </CardContent>
    </Card>
  );
}
